...
namespace LinkGroup.DemoTests.Pages
{
    public class LinkGroupPages
    {
        ...
        IWebElement homePageHeading => driver.FindElement(By.Id("las-logo"));
        IWebElement searchDrpDwn => driver.FindElement(By.Id("TN-search"));
        IWebElement searchTxtBx => driver.FindElement(By.Name("searchTerm"));
        IWebElement searchBtn => driver.FindElement(By.XPath("//button[text()='Search']"));
        IWebElement searchResults => driver.FindElement(By.XPath("//h4[contains(text(),'Leeds')]"));
