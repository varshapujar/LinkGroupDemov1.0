...
namespace LinkGroup.DemoTests.Pages
{
    public class LinkFundSolutionsPages
    {
        ...
        IWebElement agreeBtn => driver.FindElement(By.XPath("//a[text()='Agree']"));
        IWebElement fundsDrpDwn => driver.FindElement(By.Id("navbarDropdown"));
        IWebElement unitedKingdomFundLink => driver.FindElement(By.XPath("//a[contains(text(),'UK')]"));
        IWebElement switzerlandFundLink =>  driver.FindElement(By.XPath("//a[contains(text(),'Swiss')]"));
        IWebElement fundsForUK => driver.FindElement(By.XPath("//h1[contains(text(),'UK')]"));
        IWebElement fundsForSwiss => driver.FindElement(By.XPath("//h1[contains(text(),'Swiss')]"));
